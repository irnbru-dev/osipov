...
<section class="contacts wow fadeIn">
    <div class="container">
        <div class="contacts__box">
            ...
            <div class="map" style="background: url(<?= get_field('contacts')['background'] ?>); background-size: cover; background-repeat: no-repeat;">
...
<noscript>
    <div><img src="https://mc.yandex.ru/watch/56009290" style="position:absolute; left:-9999px;" alt=""/></div>
</noscript>
<!-- /Yandex.Metrika counter -->
